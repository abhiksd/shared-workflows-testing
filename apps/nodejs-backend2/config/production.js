 ...
 * Enterprise-grade configuration for production AKS cluster with maximum security and performance
 */
...
module.exports = {
  ...
  server: {
    ...
    bodyParser: {
      limit: '10mb',
      urlencoded: {
        extended: false, // More secure for production
        limit: '10mb'
      },
      json: {
        limit: '10mb'
  ...
  database: {
    ...
    dialectOptions: {
      ...
      query_timeout: 30000,
      application_name: 'nodejs-app-production'
    },
    extra: {
  ...
  security: {
    ...
    rateLimiting: {
      ...
      max: 1000, // Strict rate limiting for production
    ...
    jwt: {
      issuer: process.env.JWT_ISSUER || 'nodejs-app-production',
      audience: process.env.JWT_AUDIENCE || 'nodejs-app-users',
      algorithm: 'RS256',
      expiresIn: '1h', // Short expiration for production
      clockTolerance: 60
    }
  },

  // OAuth2/OIDC configuration for production
  oauth2: {
  ...
  monitoring: {
    ...
    tracing: {
      enabled: true,
      serviceName: 'nodejs-app-production',
  ...
  features: {
    enableNewFeature: false, // Conservative in production
