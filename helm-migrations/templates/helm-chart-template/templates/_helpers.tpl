...
1. Replace all occurrences of "app-template" with your application name
2. The function names should match your Chart.yaml name field
3. Example: If your app is "my-spring-app", replace "app-template" with "my-spring-app"
*/}}